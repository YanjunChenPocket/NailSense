...
/**
 * ADS1263 6-sensor HARDENED firmware (Teensy 4.0)
 * Three ADC boards read six 4-channel nail sensors (24 values total).
 * Shared SPI bus (SCK=13, MOSI=11, MISO=12); per-board CS + DRDY.
 * Add boards by extending BOARDS[] — everything else scales automatically.
 *
...
static const uint8_t NUM_BOARDS = 3;
